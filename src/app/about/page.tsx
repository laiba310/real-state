    ...
    return (
        <div>
            ...
            <div className='max-w-3xl flex flex-col justify-center items-center'>
                ...
                <button className='py-4 px-4 md:px-6 bg-[#0093FF] text-[10px] rounded-md text-white transform hover:scale-105'>Current Opportunities</button>
                <button className='py-4 px-4 md:px-6 text-black text-[10px] rounded-md  border-black border font-bold transform hover:scale-105'>Learn More About Investment</button>
                </div>
            </div>    

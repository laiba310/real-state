    ...
    <main>
        ...
        <div className='flex flex-col justify-center items-center space-y-2' style={{
           ...
           height:"40vh"
            ...
            <button className='py-4 px-6 text-md text-white text-[10px] rounded-md  border-white border font-bold transform hover:scale-105'>View Current Opportunities</button>
        </div>
    </main>

    ...
    <main className='flex justify-center items-center bg-white text-black py-32 space-x-32 overflow-clip'>
        <section className=' max-w-md'>
            ...
            <div className='space-x-3'>
                <button className='py-4 px-4 md:px-6 bg-[#0093FF] text-[15px] transform hover:scale-105 rounded-md text-white '>Become Investor now</button>
                <button className='py-4 px-6 text-[#0093FF] text-[10px] rounded-md bg-white border-[#0093FF] border font-bold transform hover:scale-105'>Learn More About the project</button>
            </div>
        </section>
        <section className='hidden md:block transform hover:scale-105 '>

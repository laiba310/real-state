        ...
        <section className='mx-0 md:mx-32 lg:mx-20  py-10 flex justify-center'>
            ...
            <div className=''>
                ...
                <div className='flex flex-col ml-4 mt-6 space-y-6'>
                    ...
                    <button className='py-2 px-6 bg-[#0093FF] text-md font-semibold rounded-md text-white max-w-[430px] transform hover:scale-105'>join mailing list</button>

                </div>
                <div className=' lg:flex flex-col justify-center items-center hidden  lg:-space-y-20 space-x-20 -mt-32 transform hover:scale-105'>
